...
<div id="page" class="container">
    <div id="header">
        <div id="logo">
            ...
            <h1><%=assistant.getName()%>
            </h1>
        </div>
        <div id="menu">
            <ul>
                <li class="current_page_item"><a href="/Convenience_Store/commodity_display">查询商品信息</a></li>
                <li><a href="../Assistant/main.jsp?info=<%=assistant%>">个人信息</a></li>
                <li><a href="../Assistant/updateAssistant.jsp?info=<%=assistant%>">修改信息</a> </li>
                <li><a href="../Assistant/resetPassword.jsp?info=<%=assistant%>">更改密码</a> </li>
            ...
            <table id="table" width="800" frame="box" align="center">
                ...
                <tr>
                    <form method="post" action="/Convenience_Store/commodity_update">
                        ...
                        <td><input value="<%=comm.getPrice()%>" name="commprice" class="table-input"></td>
                        <input value="<%=comm.getId()%>" name="commno" type="hidden">
                        <td><input type="submit" class="update-btn" value="修改商品信息" href="/Convenience_Store/commodity_update">&nbsp;<a
...
<script>
    ...
    //document.getElementById("buy-dialog").
</script>
</body>
</html>